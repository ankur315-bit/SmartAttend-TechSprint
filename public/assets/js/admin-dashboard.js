(function () {
    ...
    // Render users table with credentials
    function renderUsersTable() {
        ...
        allUsers.forEach(u => {
            ...
            html += `<tr>
                ...
                <td>
                    <button class="btn btn-sm btn-outline-secondary" onclick="viewUserDetails('${u._id}')" title="View Details">
                        <i class="bi bi-eye"></i>
                    </button>
                    <button class="btn btn-sm btn-outline-info" onclick="sendEmailToUser('${u._id}')" title="Send Email">
                        <i class="bi bi-envelope"></i>
                    </button>
                    <button class="btn btn-sm btn-outline-primary" onclick="editUser('${u._id}')" title="Edit">
                        <i class="bi bi-pencil"></i>
                    </button>
                    <button class="btn btn-sm btn-outline-danger" onclick="deleteUser('${u._id}')" title="Delete">
